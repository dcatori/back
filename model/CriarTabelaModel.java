...
public class CriarTabelaModel {
     ...
     public static void main(String[] args) {
        ...
        try{
            ...
            String strSqlCriarTabela = "create table `db_teste`.`tbl_teste` (`id` int not null auto_increment, `nome` varchar(255) not null, `email` varchar(255) not null, `senha` varchar(255) not null, `img` varchar(255), primary key (`id`));";
