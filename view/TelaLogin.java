    ...
    public TelaLogin(){
       ...
       //entrarJButton.addActionListener(new ActionListener() {
            //public void actionPerformed(ActionEvent event){
                ...
                //try{
                    ...
                    //String strSqlEditarCadastro = "select * from `" + db + "`.`" + tbl + "` where `nome` like '%" + //nome + "%' or `email` like '%" + email + "%' order by `id` asc limit 1;";
                    //Statement stmSqlEntrar = conexao.createStatement();
                    //ResultSet rsEntrar = stmSqlEntrar.executeQuery(strSqlEditarCadastro);
       ...
       //});
        ...
        cadastrarJButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event){
                CadastrarRegistro cadastrarRegistro = new CadastrarRegistro();
