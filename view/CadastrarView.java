...
public class CadastrarView extends JFrame {
    ...
    public CadastrarView(TelaPrincipalView telaPrincipal) {
        ...
        cadJButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // Aqui você pode implementar a lógica para o cadastro
                notificacaoJLabel.setText("Cadastro realizado com sucesso!"); // Exemplo
